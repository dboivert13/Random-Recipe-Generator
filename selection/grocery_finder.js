$(document).ready(function () {
        ...
        if (address == "") {
            ...
            $.ajax({
                ...
                $.ajax({
                    ...
                    for (var i = 0; i < 5; i++) {
                        $("#search-result-label").text("Showing Results For: " + res.features[0].place_name);
    ...
    // Writing function for user to save home address for future searches
    function setHome() {
    ...
    // Writing function that will pull home address from local storage and run the findGrocery function
    function homeSearch() {
